# CNVS Reports Directory

This directory contains the official documentation and technical reports for the **Closed Native Verification Systems (CNVS)** Monte Carlo Test Suite.

## Contents

1. **`Report_Monte_Carlo_ENG.pdf`**
...
The documents in this directory are released under the **CC BY-NC 4.0** License.
See the `LICENSE-DOCS.md` file in the repository root for full details.
